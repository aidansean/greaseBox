...
// @description    Replaces faces with bunnies
...
for(var i=0 ; i<divs.length ; i++)
{
  if(divs[i].className=='thumb' || divs[i].className=='icon')
  {
    ...
    imgs[0].src = 'http://www.aidansean.com/greasemonkey/rabbits/' + (1+Math.floor(Math.random()*5)) + '_60.jpg' ;
  }
}
...
for(var i=0 ; i<divs.length ; i++)
{
  if(imgs[i].className=='headshot')
  {
    ...
    {
      imgs[i].src = 'http://www.aidansean.com/greasemonkey/rabbits/' + (1+Math.floor(Math.random()*5)) + '_60.jpg' ;
    }
    else
    {
      imgs[i].src = 'http://www.aidansean.com/greasemonkey/rabbits/' + (1+Math.floor(Math.random()*5)) + '_30.jpg' ;
    }
  }
}
